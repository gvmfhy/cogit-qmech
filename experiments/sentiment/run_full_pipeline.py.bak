...
class PipelineRunner:
    ...
    def run_pipeline(self) -> bool:
        ...
        if not self.run_phase(3, "quantum_phase3_test.py", "Test Interventions"):
            return False
        if not self.validate_phase3():
            return False

        # Phase 4: Test Reversibility
        if not self.run_phase(4, "test_reversibility.py", "Test Reversibility"):
            return False
...
def main():
    ...
    runner = PipelineRunner(args.preset)
